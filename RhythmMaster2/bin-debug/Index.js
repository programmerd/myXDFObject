...
var Index = (function (_super) {
    ...
    function Index() {
        ...
        _this.jiezou5 = {
            // take: "tickling",			//接收返回值使用 可传可不传
            dom: "animateGroup",
            dragonbonesData: "jiezou5_ske_json",
            textureData1: "jiezou5_tex_json",
            texture1: "jiezou5_tex_png",
            name: "jiezou5",
            count: 1 //必传
        };
        _this.jiezou6 = {
            // take: "tickling",			//接收返回值使用 可传可不传
            dom: "animateGroup",
            dragonbonesData: "jiezou6_ske_json",
            textureData1: "jiezou6_tex_json",
            texture1: "jiezou6_tex_png",
            name: "jiezou6",
            count: 1 //必传
        };
        _this.changpian = {
    ...
    Index.prototype.changNumber = function () {
        ...
        this.resultEnabled[this.subNum.value - 1].map(function (item) {
    ...
    Index.prototype.animationFun = function (dbObj) {
        ...
        armature.addEventListener(dragonBones.EventObject.COMPLETE, function () {
            ...
            if (_this.isPlayMusic) {
                ...
                if (_this.isPlayAnimate.length >= 6 && _this.subNum.value <= 1) {
                    _this.subNum.value++;
                    _this.isPlayMusic = false;
                    _this.musicFun();
                }
                else if (_this.isPlayAnimate.length >= 6 && _this.subNum.value >= 2) {
                    console.log("恭喜通关");
                    _this.isPlayMusic = false;
                    _this.musicFun();
                ...
                if (dbObj.name == "jiezou1") {
                    ...
                    _this.animationFun(_this.jiezou5);
                }
                else if (dbObj.name == "jiezou6") {
                    _this.animationFun(_this.jiezou6);
                }
            }
        }, this);
        return armature;
