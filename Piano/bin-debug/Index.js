...
var Index = (function (_super) {
    ...
    function Index() {
        ...
        _this.subNum = new Value(1);
        _this.numberArr = [2, 5, 4, 25, 8, 125, 3, 9];
        _this.smallStart = [
            ["Do", "Do", "So", "So", "La", "La", "So", "Fa", "Fa", "Mi", "Mi", "Re", "Re", "Do", "So", "So", "Fa", "Fa", "Mi", "Mi", "Re", "So", "So", "Fa", "Fa", "Mi", "Mi", "Re"],
            ["Mi", "Mi", "Mi", "Fa", "So", "Mi", "Re", "Do", "Do", "Do", "Re", "Mi", "Mi", "Ti2", "La2", "Mi", "Re", "La2", "Mi", "Re", "La2", "Mi", "Re", "Do", "Do"],
            ["Mi", "Mi", "Re", "Do", "Re", "Do", "Ti2", "La2", "La2", "La2", "Fa", "Fa", "Mi", "Re", "Do", "Re", "Fa", "Mi", "Fa", "Fa", "Mi", "Re", "Re", "Fa", "Mi", "Mi", "Do", "La2", "La2", "Ti2", "Mi", "Mi", "Re", "Do", "Ti2", "Do", "La2"],
            [
                "So", "So", "La", "So", "Do8", "Ti",
                "So", "So", "La", "So", "Re8", "Do8",
