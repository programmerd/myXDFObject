window.skins={};
	...
	_proto.clickNum_i = function () {
		...
		t.x = 155.5;
		t.y = 354;
		t.elementsContent = [this._Image7_i(),this._Image8_i(),this._Image9_i(),this._Image10_i(),this._Image11_i(),this._Image12_i(),this._Image13_i(),this._Image14_i()];
		return t;
	};
	...
	_proto.clickNum1_i = function () {
		...
		t.x = 155.5;
		t.y = 354;
		t.elementsContent = [this._Image15_i(),this._Image16_i(),this._Image17_i(),this._Image18_i(),this._Image19_i(),this._Image20_i()];
		return t;
	};
	...
	_proto.timuGroup_i = function () {
		...
		t.x = -1.5;
		t.y = 0;
		t.elementsContent = [this._Rect1_i(),this._Image22_i()];
		return t;
	};
	...
	_proto.tipGroup_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Rect2_i(),this._Image23_i()];
		return t;
	};
